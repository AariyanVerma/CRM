  ...
  return (
    ...
    >
      ...
      <div className="animate-fade-up mt-10 flex justify-center [animation-delay:260ms]">
        <Link
          href="/calculator"
          className="calc-cta group relative inline-flex min-h-[58px] items-center justify-center overflow-hidden rounded-full bg-gradient-to-r from-slate-800 via-slate-900 to-ink px-10 text-lg font-extrabold text-white shadow-[0_12px_30px_rgba(15,23,42,0.28)] transition-transform duration-300 hover:-translate-y-2 hover:scale-[1.06] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-slate-500 active:scale-[0.97]"
        >
          ...
          <span className="relative z-10 flex items-center gap-2.5 tracking-wide">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/15 transition duration-300 group-hover:rotate-12 group-hover:bg-white/25" aria-hidden>
